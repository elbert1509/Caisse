...
import com.example.gestion.data.StockUiRow
import com.example.gestion.data.toStockUiRow
import com.example.gestion.data.formatNumberFr
...
fun StockScreen(navController: NavController, viewModel: MenuViewModel) {
    ...
    val totalBenefit = remember(lignes) { lignes.sumOf { it.benefit } }
                ...
                Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    ...
                    Row(
                        ...
                        KpiCard(
                            ...
                            value = totalBenefit,
                            gradient = Brush.linearGradient(listOf(Color(0xFF16A34A), Color(0xFF166534))),
                            modifier = Modifier.weight(1f),
                            devise = shopInfos?.devise ?: ""
                        )
                    }
    ...
    Card(
        ...
        Box(
            ...
            Column(Modifier.align(Alignment.TopStart)) {
                ...
                Spacer(Modifier.height(6.dp))
                Text(
                    text = if (isMoney) formatPrice( value,devise) else value.formatNumberFr(),
