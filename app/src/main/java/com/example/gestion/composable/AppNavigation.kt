...
import com.example.gestion.bluetooth.BluetoothViewModel
import com.example.gestion.bluetooth.ParametreBluetooothScreen
import com.example.gestion.data.DashboardViewModel
import com.example.gestion.data.HomeActionButton
...
fun AppNavigation() {
    ...
    NavHost(navController,
        ...
        composable("produit") { ProductScreen(  modifier = Modifier,
            viewModel = menuViewModel, navController = navController
        ) }
