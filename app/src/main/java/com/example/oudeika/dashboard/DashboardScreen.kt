...
import com.example.oudeika.ui.theme.Indigo
import com.example.oudeika.ui.theme.MintEnd
import com.example.oudeika.ui.theme.MintStart
import com.example.oudeika.ui.theme.Slate100
import com.example.oudeika.ui.theme.Slate500
import com.example.oudeika.ui.theme.Slate700
import com.example.oudeika.ui.theme.Slate900
...
fun DashboardScreen(navController: NavController, viewModel: DashboardViewModel, menuViewModel: MenuViewModel) {
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                KpiRow(today = salesToday, week = salesThisWeek, month = salesThisMonth, navController = navController, devise = devise)
            }
            ...
            item {
                Card(
                    ...
                    Column(Modifier.padding(14.dp)) {
                        Text("Ventes de la semaine", style = MaterialTheme.typography.titleMedium, color = Slate900)
                                ...
                                val dataSet = LineDataSet(entries, "").apply {
                                    ...
                                    valueFormatter = object : com.github.mikephil.charting.formatter.ValueFormatter() {
                                        override fun getPointLabel(entry: Entry?): String =
                                            if (entry != null && entry.y > 0f) formatPrice(
                                                entry.y.toDouble(),devise = devise) else ""
                                    }
            ...
            item {
                Card(
                    ...
                    Column(Modifier.padding(14.dp)) {
                        Text("Ventes par mois", style = MaterialTheme.typography.titleMedium, color = Slate900)
                        Spacer(Modifier.height(8.dp))
                        AndroidView(
            ...
            item {
                Card(
                    ...
                    Column(Modifier.padding(14.dp)) {
                        Text("Répartition par catégorie", style = MaterialTheme.typography.titleMedium, color = Slate900)
                        Spacer(Modifier.height(8.dp))
            ...
            item {
                Card(
                    ...
                    Column(Modifier.padding(14.dp)) {
                        Text("Meilleurs produits", style = MaterialTheme.typography.titleMedium, color = Slate900)
                        Spacer(Modifier.height(8.dp))
                        AndroidView(
                            factory = { context -> BarChart(context) },
                            modifier = Modifier.fillMaxWidth().height(280.dp),
...
@Composable
private fun KpiRow(today: Double, week: Double, month: Double,navController: NavController, devise : String? = null) {
    Row(
    ...
    Card(
        ...
        Box(
            ...
            Column(Modifier.align(Alignment.TopStart)) {
                ...
                Text(
                    text = formatPrice(amount = amount, devise = devise),
