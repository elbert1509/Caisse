...
import com.example.gestion.data.Vente
import com.example.gestion.data.VenteLigne
...
class SyncWorker(
    ...
    private fun tableToMap(t: com.example.gestion.data.AppTable) = mapOf(
        "id" to t.id.toString(),
        "name" to t.name,
        "active" to t.active,
    ...
    private fun tableItemToMap(ti: com.example.gestion.data.TableItem) = mapOf(
    ...
    private fun mapToTable(m: Map<String, Any?>) = com.example.gestion.data.AppTable(
    ...
    private fun mapToTableItem(m: Map<String, Any?>) = com.example.gestion.data.TableItem(
        id = UUID.fromString(m["id"] as String),
    ...
    private fun categorieToMap(c: com.example.gestion.data.Category) = mapOf(
        "id" to c.id.toString(),
        "name" to c.name,
    ...
    private fun infosToMap(i: com.example.gestion.data.ShopInfos) = mapOf(
        "id" to i.id,
        "name" to i.name,
    ...
    private fun mapToInfos(m: Map<String, Any?>) = com.example.gestion.data.ShopInfos(
    ...
    private fun mapToCategorie(m: Map<String, Any?>) = com.example.gestion.data.Category(
        id = UUID.fromString(m["id"] as String),
        name = m["name"] as String,
    ...
    private fun vendeurToMap(v: com.example.gestion.data.Vendeur) = mapOf(
        "id" to v.id.toString(),
        "nom" to v.nom,
        "prenom" to v.prenom,
        "updatedAt" to v.updatedAt,
    ...
    private fun mapToVendeur(m: Map<String, Any?>) = com.example.gestion.data.Vendeur(
        id = (m["id"] as? Number)?.toInt() ?: 0,
        nom = m["nom"] as String,
