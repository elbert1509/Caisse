...
fun ProductScreen(
    ...
    var purchasePrice by remember { mutableStateOf(TextFieldValue("")) }
    ...
    var renamePurchasePrice by remember { mutableStateOf(TextFieldValue("")) }
                ...
                items(filteredProducts, key = { it.id }) { product ->
                    ProductRow(
                        ...
                        onRename = {
                            ...
                            renamePurchasePrice = TextFieldValue(product.prix_achat?.toString() ?: "")
                        },
            ...
            AlertDialog(
                ...
                text = {
                    Column {
                        ...
                        Spacer(Modifier.height(8.dp))
                        OutlinedTextField(
                            value = renamePurchasePrice,
                            onValueChange = { renamePurchasePrice = it },
                            label = { Text("Prix d'achat") },
                            modifier = Modifier.fillMaxWidth()
                        )
                        Spacer(Modifier.height(8.dp))
                ...
                confirmButton = {
                    TextButton(onClick = {
                        ...
                        val purchasePrice = renamePurchasePrice.text.trim().toDoubleOrNull()
